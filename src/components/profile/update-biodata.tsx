...
export default function UpdateBiodata() {
    ...
    const translations = {
        id: {
            updateBiodata: "Lengkapi Biodata",
    ...
    const handleConfirmPassword = async () => {
        ...
        try {
            ...
            toast.error(`${t.errorOccurred}: ${err.message || "Something went wrong"}`);
        } finally {
            setLoading(false);
        }
    };
        ...
        <>
            ...
            >
                <DialogTrigger asChild>
                    ...
                    >
                        <Key className="h-3.5 w-3.5 mr-1"/> {t.updateBiodata}
                    </Badge>
                </DialogTrigger>
                <DialogContent>
                    <DialogHeader>
                    ...
                    <DialogFooter className="flex flex-row justify-center gap-5">
                        ...
                        <DialogClose asChild>
                            <Button type="button" className="bg-primary hover:bg-primary/70" tabIndex={2}>
                                {t.no}
                            </Button>
                        </DialogClose>
                    </DialogFooter>

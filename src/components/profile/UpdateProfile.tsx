        ...
        <div className="flex max-md:flex-col gap-10">
          <div className="flex gap-4 flex-col max-md:w-full w-1/3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input type="textarea" required id="motto" name="motto" value={biodataNew.motto} onChange={handleChange}
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input required id="tanggal_lahir" name="tanggal_lahir" type="date" value={biodataNew.tanggal_lahir}

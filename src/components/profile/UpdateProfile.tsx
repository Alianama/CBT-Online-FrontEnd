    ...
    <Layout data={pageData[safeLocale]}>
      <div className="container gap-10 mx-auto py-6 px-4 md:px-6 flex flex-col">
          ...
          <div className="flex gap-4 flex-col max-md:w-full w-1/3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setbiodataNew({ ...biodataNew, jenis_kelamin: value })
                }
              >
              ...
              <Select
                ...
                onValueChange={async (value) => {
                  const selectedProvince = provinces.find(
                    (province: Province) => province.name === value
                  );
                  ...
                  <SelectGroup>
                    ...
                    {provinces?.map(
                      (province: { id: string; name: string }) => (
                        <SelectItem
                          onSelect={() => handleSelectKota(province.id)}
                          key={province.id}
                          value={province.name}
                        >
                          {province.name}
        ...
        >
          ...
          >
            <DialogHeader>{t.verifyPhone}</DialogHeader>
            <Form {...form}>
              <form
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription
                        onChange={() => setVerifyOTPMessage(null)}

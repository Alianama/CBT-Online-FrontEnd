...
// //     console.log(soal)
// //     useEffect(() => {
// //         if (soal) setLoading(false)
// //     }, [soal])
// //     useEffect(() => {
// //         const answeredCount = Object.keys(answers).length
// //         const totalQuestions = soal?.length || 0
// //         setProgress((answeredCount / totalQuestions) * 100)
// //     }, [answers, soal])
// //     const handleAnswerChange = (questionId: number, answer: string) => {
// //         setAnswers((prev) => ({
...
// //     }
// //     const handleSubmit = () => {
// //         if (!soal || Object.keys(answers).length < soal.length) {
// //             toast.warning("Mohon jawab semua pertanyaan sebelum mengirim.")
// //             return
// //         }
// //         sendJsonMessage(answers)
// //         toast.success("Ujian Berhasil Dikirim")
// //         console.log("Submitted answers:", answers)
// //     }
// //     const renderQuestionContent = (question: Question) => {
...
// //                                 question[option as keyof Question] && (
// //                                     <div key={option}
// //                                          className="flex items-center space-x-2 rounded-lg border p-3 transition-colors hover:bg-gray-100">
// //                                         <RadioGroupItem
// //                                             value={option}
// //                                             id={`${question.id_soal_ujian}-${option}`}
// //                                             onClick={() => {
...
// //                                         />
// //                                         <Label
// //                                             htmlFor={`${question.id_soal_ujian}-${option}`}
// //                                             className="flex-1 cursor-pointer"
// //                                         >
// //                                             <span
// //                                                 dangerouslySetInnerHTML={{__html: `${option.toUpperCase()}. ${question[option as keyof Question] || ""}`,}}
// //                                             />
// //                                         </Label>
// //
// //                                     </div>
...
// //         )
// //     }
// //     const isQuestionAnswered = (questionId: number) => !!answers[questionId]
// //     if (loading || !soal) {
// //         return (
// //             <div className="p-6 text-center">
// //                 <p>Memuat soal...</p>
...
// //
// //                     <div className={`flex ${isMobile ? "flex-col" : "flex-row"} h-full`}>
// //                         <div className={`${isMobile ? "w-full p-4 border-b" : "w-1/4 p-4 border-r"} bg-white`}>
// //                             <h2 className="text-lg font-semibold mb-4">Nomor Soal</h2>
// //                             <div className={`grid ${isMobile ? "grid-cols-5 sm:grid-cols-8" : "grid-cols-3"} gap-2`}>
...
// //                                         key={question.id_soal_ujian}
// //                                         variant={currentQuestion === index ? "default" : "outline"}
// //                                         className={`relative ${isQuestionAnswered(question.id_soal_ujian) ? "border-green-500" : ""}`}
// //                                         onClick={() =>
...
// //                                 <h2 className="text-xl font-bold">Soal {currentQuestion + 1}</h2>
// //                                 <div className="flex items-center gap-2">
// //                                     {isQuestionAnswered(soal[currentQuestion]?.id_soal_ujian) ? (
// //                                         <span className="text-green-500 flex items-center gap-1">
// //                       <CheckCircle2 className="h-4 w-4"/> Terjawab
// //                     </span>
// //                                     ) : (
...
// //                             </div>
// //
// //                             {soal[currentQuestion] && renderQuestionContent(soal[currentQuestion])}
// //
// //                             <div className="mt-8 flex justify-between">
// //                                 <Button
// //                                     variant="outline"
...
// //                                     <Button
// //                                         onClick={handleSubmit}
// //                                         disabled={Object.keys(answers).length < soal.length}
// //                                         className="bg-green-600 hover:bg-green-700"
// //                                     >
// //                                         Kirim Jawaban
// //                                     </Button>
// //                                 ) : (
// //                                     <Button
// //                                         onClick={() => setCurrentQuestion(Math.min(soal.length - 1, currentQuestion + 1))}>
// //                                         Soal Berikutnya
// //                                     </Button>
// //                                 )}
// //                             </div>
...
// //                                 className="w-full bg-green-600 hover:bg-green-700"
// //                             >
// //                                 Kirim Jawaban ({Object.keys(answers).length}/{soal.length})
// //                             </Button>
// //                         </div>
// //                     )}
// //                 </Card>
...
//                             question[option as keyof Question] ? (
//                                 <div key={option} className="flex items-center space-x-2 border p-3 rounded-lg hover:bg-gray-100 transition-colors">
//                                     <RadioGroupItem
//                                         value={option}
//                                         id={`${question.id_soal_ujian}-${option}`}
//                                     />
//                                     <Label htmlFor={`${question.id_soal_ujian}-${option}`} className="flex-1 cursor-pointer">
//                                         <span dangerouslySetInnerHTML={{ __html: `${option.toUpperCase()}. ${question[option as keyof Question] || ""}` }} />
//                                     </Label>
//                                 </div>
//                             ) : null
//                         )}
...
//                 )}
//
//                 {/* Jawaban Gambar (jika kamu ingin menambahkan di masa depan) */}
//                 {question.tipe === "3" && (
//                     <div className="text-gray-600 italic">Soal tipe khusus (misalnya gambar atau file upload).</div>
//                 )}
//             </div>
//         )
//     }
//
//     if (loading) return <div className="text-center text-gray-500 py-10">Memuat soal...</div>
//     if (!soal || soal.length === 0) return <div className="text-center text-red-500 py-10">Tidak ada soal ditemukan.</div>
//
//     return (
//         <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
//             <div className="flex items-center justify-between">
//                 <h1 className="text-xl font-bold">Ujian Online</h1>
//                 <span className={`text-sm ${readyState === 1 ? "text-green-600" : "text-yellow-500"}`}>
//                     Status: {statusList[readyState]}
//                 </span>
//             </div>
//
...
//                     Soal {currentQuestion + 1} dari {soal.length}
//                 </div>
//                 {renderQuestionContent(soal[currentQuestion])}
//             </Card>
//

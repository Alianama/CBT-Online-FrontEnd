              ...
              {question.tipe === "1" && (
                ...
                >
                    {["a", "b", "c", "d", "e"].map(
                      (option) =>
                        question[option as keyof Question] && (
                          <div key={option} className="flex items-center space-x-2 rounded-lg border p-3 transition-colors hover:bg-gray-100">
                              <RadioGroupItem
                                value={option}
                                id={`${question.id_soal_ujian}-${option}`}
                                // onClick={()  => {console.log(question.id_soal_ujian)}}
                      ...
                      <AlertCircle className="h-4 w-4" /> Belum Terjawab
                          ...
                          <div className="mt-8 flex justify-between">
                              ...
                              {currentQuestion === soal.length - 1 ? (
                                ...
                                <Button onClick={() => setCurrentQuestion(Math.min(soal.length - 1, currentQuestion + 1))}>
                                    Soal Berikutnya
                                </Button>
                              )}
                          </div>
